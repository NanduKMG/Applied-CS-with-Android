...
public class BinaryTreeView extends View {
    ...
    private ArrayList<Integer> origSequence = null;
    ...
    public void initialize() {
        ...
        origSequence = generateRandomSequence(TREE_SIZE);
        Log.d("Orig sequence",origSequence.toString());
        for (int value : origSequence) {
            tree.insert(value);
        }
                ...
                case MotionEvent.ACTION_DOWN:
                    ...
                    if (hitValue != -1) {
                        ...
                        if (hitValue != targetValue) {
                            ...
                            Log.d("search",searchSequence.toString());
                        }
                        searchPosition++;
                        updateMessage();
                        return true;
